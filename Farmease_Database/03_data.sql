...
-- Author: Pragya
-- Upgraded: Added TRUNCATE for safe, repeatable execution.
-- ============================================

-- CLEAR EXISTING DATA (Prevents duplicates if the script is run multiple times)
TRUNCATE TABLE crop_equipment_map RESTART IDENTITY CASCADE;
