...
const handleAccept = async (e, notification) => {
  ...
  try {
    ...
    // 1. Instantly hide the buttons in the UI for a snappy UX
    setNotifications((prev) =>
    ...
    // Optional: Keep reload if you absolutely need MyBookings to sync behind the scenes, 
    // but the card will already be "read" and buttonless before the reload fires.
