              ...
              <div className="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2 text-[#006F1D] font-bold">
                    <span>👤</span><h3 className="text-[#2D3432] text-sm md:text-base">{t('basicInfo')}</h3>
                  </div>

                  {/* Changed to flex-col on mobile, grid on md+ */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="col-span-1 md:col-span-2">
                      <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('fullName')}</label>
                    ...
                    <div>
                      <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('phoneNumber')}</label>
                    ...
                    <div>
                      <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('emailAddress')}</label>
                    ...
                    <div>
                      <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('passwordField')}</label>
                    ...
                    <div>
                      <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('confirmPassword')}</label>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-2 text-[#006F1D] font-bold">
                    <span>🆔</span><h3 className="text-[#2D3432] text-sm md:text-base">{t('identityDetails')}</h3>
                  </div>

                  {/* Changed to flex-col on mobile, grid on md+ */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('aadhaarPan')}</label>
                    ...
                    <div>
                      <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('kisanIdLabel')}</label>
                    ...
                    <div className="col-span-1 md:col-span-2">
                      <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('uploadAadhaar')}</label>
                ...
                <div className="pt-2 md:pt-4 text-center lg:text-left">
                  ...
                  <p className="text-xs md:text-sm font-bold text-[#59615F] mt-5 md:mt-4">
                    {t('alreadyHaveAccount')} <span onClick={() => navigate('/login')} className="text-[#006F1D] underline cursor-pointer font-bold ml-1">{t('loginBtn')}</span>
                  </p>
                </div>
              </div>
            )}
              ...
              <div className="space-y-6 md:space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                ...
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0">
                    <div className="flex items-center space-x-2 text-[#006F1D] font-bold"><span>📍</span><h3 className="text-[#2D3432] text-sm md:text-base">{t('locationInfo')}</h3></div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <input name="village" value={formData.village} onChange={handleChange} className="bg-[#F1F4F2] border-none rounded-xl px-4 py-3 md:py-3.5 text-sm md:text-base focus:ring-2 focus:ring-[#006F1D]" placeholder={t('villageName')} required />
                ...
                <div className="space-y-4">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0">
                    <div className="flex items-center space-x-2 text-[#006F1D] font-bold">
                      <span>🌾</span><h3 className="text-[#2D3432] text-sm md:text-base">{t('farmProfile') || "Farm Profile"}</h3>
                    </div>
                  ...
                  {!isNotFarmer && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 transition-all duration-300">
                      ...
                      <div>
                        <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('farmerType') || "Farmer Type"}</label>
                      ...
                      <div className="col-span-1 md:col-span-2">
                        <label className="block text-xs md:text-sm font-bold text-[#2D3432] mb-1.5">{t('primaryCrops') || "Primary Crops"}</label>
