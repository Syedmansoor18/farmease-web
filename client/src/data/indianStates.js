...
export const INDIA_DATA = {
  ...
  "Andhra Pradesh": [
    ...
    "Tirupati", "Visakhapatnam", "Vizianagaram", "West Godavari", "Y.S.R. Kadapa"
  ],
  "Arunachal Pradesh": [
  ...
  "Bihar": [
    "Araria", "Arwal", "Aurangabad", "Banka", "Banka", "Begusarai", "Bhagalpur", 
  ...
  "Karnataka": [
    ...
    "Chamarajanagara", "Chikkaballapur", "Chikkamagaluru", "Chitradurga", 
  ...
  "Uttar Pradesh": [
    ...
    "Banda", "Barabanki", "Bareilly", "Basti", "Bhadohi", "Bijnor", "Bulandshahr", 
...
// Automatically generate the array of State names from the keys above
export const STATE_NAMES = Object.keys(INDIA_DATA);