...
import Sdrill6 from "/Sdrill6.jpg";
import Sdrill7 from "/Sdrill7.jpg";
...
const myBookings = [
  ...
  { id: 4, label: "ACTIVE",   labelColor: "bg-green-600",   name: "Rotavator",             price: "₹300", img: Tr3      },
  { id: 5, label: "ACTIVE",   labelColor: "bg-green-600",   name: "Rotavator",             price: "₹300", img: Tr4      },
];

const savedEquipment = [
  { id: 1, name: "Combine Harvester", sub: "2 reviews", img: H1      },
...
const myPostings = [
  ...
  { id: 2, name: "Combine Harvester", sub: "2 reviews", img: H1 },
...
const accountSettings = [
  ...
  { id: 2, label: "Language Settings", icon: (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-gray-500">
...
const helpSupport = [
  { id: 1, label: "Help Center", icon: (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-gray-500">
      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z"/>
    </svg>
  )},
  { id: 2, label: "Contact Support", icon: (
    <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current text-gray-500">
...
const ProfileSidebar = ({ onNavigate, screen }) => (
  <div
...
const StatsBar = () => (
  <div className="flex items-center justify-around border-b border-gray-100 py-4 bg-white">
    ...
    <div className="flex flex-col items-center gap-0.5">
      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-green-600"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c1.93 0 3.5 1.57 3.5 3.5S13.93 13 12 13s-3.5-1.57-3.5-3.5S10.07 6 12 6zm7 13H5v-.23c0-.62.28-1.2.76-1.58C7.47 15.82 9.64 15 12 15s4.53.82 6.24 2.19c.48.38.76.97.76 1.58V19z"/></svg>
    ...
    {/* Kisan ID — Pending */}
    <div className="flex flex-col items-center gap-0.5">
      <svg viewBox="0 0 24 24" className="w-6 h-6 fill-yellow-500"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 14H4V6h16v12zM6 10h2v2H6zm0 4h8v2H6zm4-4h8v2h-8z"/></svg>
...
const ScrollSection = ({ title, children }) => (
  <div>
    <div className="flex justify-between items-center mb-2">
      ...
      <svg viewBox="0 0 24 24" className="w-7 h-7 fill-current text-gray-300 hover:text-green-600 transition-colors duration-200 cursor-pointer">
...
const SavedCard = ({ item }) => (
  <div className="flex-1 min-w-0 bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm">
    <div className="w-full aspect-video relative">
      <img src={item.img} alt={item.name} className="w-full h-full object-cover" />
      <button className="absolute top-1 right-1 bg-white rounded-full p-0.5 shadow">
        <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current text-red-400">
...
export default function Profile({ onNavigate, onLogout }) {
  return (
    <div className="min-h-screen bg-gray-100 flex w-full">
      ...
      <ProfileSidebar onNavigate={onNavigate} screen="profile" />

      <div className="flex-1 overflow-y-auto min-w-0 pl-[50px]">
        ...
        <div className="p-4 space-y-5">
          ...
          {/* My Bookings */}
          <ScrollSection title="My Bookings">
            {myBookings.map((item) => (
          ...
          {/* Saved Equipment */}
          <ScrollSection title="Saved Equipment">
          ...
          {/* My Postings */}
          <ScrollSection title="My Postings">
            {myPostings.map((item) => (
          ...
          {/* Account Settings */}
          <SettingsGroup title="Account Settings" items={accountSettings} />

          {/* Help & Support */}
          <SettingsGroup title="Help & Support" items={helpSupport} />
